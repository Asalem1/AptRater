            ...
            <div className="panel">
              <div className="panel-body">
                ...
                <div className="btn-toolbar text-center">
                  <div className={s.formGroup}>
                    <a className={s.facebook} /*onClick={this.handleFacebook.bind(this)}*/ href="/login/facebook">
                      <svg
                        className={s.icon}
                        width="30"
                        height="30"
                  ...
                  <div className={s.formGroup}>
                    <a className={s.google} /*onClick={this.handleGoogle.bind(this)}*/href="/login/google">
                      <svg
                        className={s.icon}
                        width="30"
                        height="30"
                  ...
                  <div className={s.formGroup}>
                    <a className={s.twitter} /*onClick={this.handleTwitter.bind(this)}*/ href="/login/twitter">
                      <svg
                        className={s.icon}
                        width="30"
                        height="30"
